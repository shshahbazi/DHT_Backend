...
urlpatterns = [
    ...
    path('work-report/daily/', DailyWorkReportAPIView.as_view(), name='daily_work_report'),
    path('work-report/weekly/', WeeklyWorkReportAPIView.as_view(), name='weekly_work_report')
